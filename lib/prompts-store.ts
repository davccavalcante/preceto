...
function buildMiniPrompt(style: StyleMode): string {
...
function buildPlusPrompt(style: StyleMode): string {
  const styleInstructions: Record<StyleMode, string> = {
    simple:
      'Use clear, direct and accessible language. Keep sentences short and straightforward.',
    concise:
...
function buildEngineerPrompt(style: StyleMode): string {
  const styleInstructions: Record<StyleMode, string> = {
    simple:
      'Use clear, direct and accessible language. Keep sentences short and straightforward.',
    concise:
...
export function buildPrompt(
  ...
  switch (model) {
    case 'mini':
      return buildMiniPrompt(style)
    case 'plus':
      return buildPlusPrompt(style)
    case 'engineer':
      return buildEngineerPrompt(style)
  }
}
